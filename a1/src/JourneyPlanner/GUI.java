...
/**
 * This is a template JourneyPlanner.GUI that you can use for your mapping program. It is an
 ...
 * class.
 * 
 * This JourneyPlanner.GUI uses Swing, not the first-year UI library. Swing is not the focus of
