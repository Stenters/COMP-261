...
/**
 * A JourneyPlanner.Location is a point in a 2D coordinate system, with increasing x from west
 ...
 * coordinate has its direction flipped from JourneyPlanner.Location objects.
 * 
 * Methods are provided to convert between these two coordinate systems, but
 * this conversion requires an origin JourneyPlanner.Location (a JourneyPlanner.Location at the origin will be
 ...
 * coordinate system used in the input files and into the JourneyPlanner.Location coordinate
 * system.
 */
...
public class Location {
	...
	/**
	 * Makes a new Point object from this JourneyPlanner.Location object and returns it. To
	...
	/**
	 * Create a new JourneyPlanner.Location object from a given Point object, as well as the
	...
	/**
	 * Create a new JourneyPlanner.Location object from the given latitude and longitude, which
	...
	// ------------------------------------------
	// some utility methods for JourneyPlanner.Location objects
	// ------------------------------------------

	/**
	 * Returns a new JourneyPlanner.Location object that is this JourneyPlanner.Location object moved by the
	 * given dx and dy, ie. this returns a JourneyPlanner.Location representing (x + dx, y +
	 * dy).
	 */
